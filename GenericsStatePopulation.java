...
public class GenericsStatePopulation {

  public static class StatePair<Type1 extends Comparable<Type1>, Type2 extends Comparable<Type2>> {
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (i = 0; i < zipCodeState.size(); ++i) {
      if (zipCodeState.get(i).getValue1().equals(myZipCode)) {
        myStateCode = zipCodeState.get(i).getValue2();
        break;
      }
    }

    for (i = 0; i < abbrevState.size(); ++i) {
      if (abbrevState.get(i).getValue1().equals(myStateCode)) {
        myStateCode = abbrevState.get(i).getValue2();
        break;
      }
    }

    for (i = 0; i < statePopulation.size(); ++i) {
      if (statePopulation.get(i).getValue1().equals(myStateCode)) {
